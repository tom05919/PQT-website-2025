...
export default function Round1Page() {
  ...
  useEffect(() => {
    fetch('/api/tournament/pairings/1')
      .then((res) => res.json())
      .then((data) => {
        setGames(data.games || []);
        setLoading(false);
  ...
  return (
    <div className="bg-[#d2c3b3] min-h-screen py-8 px-4 sm:px-6 lg:px-8">
      <Bracket games={games} roundName="Sweet 16" />
      ...
      <div className="max-w-6xl mx-auto mt-12 mb-8">
        <div className="bg-[#d8c6b8] rounded-xl p-6 border-2 border-[#b46b35]">
          ...
          <a
            href="https://docs.google.com/forms/u/2/d/e/1FAIpQLSfmGZl6O_GyhWz7bMKvzPk98e3TLNOqK0SdEfD6WjYTHoHnkg/formResponse"
            target="_blank"
      ...
      <div className="max-w-6xl mx-auto mt-8">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            <span className="text-[#463f3a] text-sm">Round 1 of 4</span>
          </div>
